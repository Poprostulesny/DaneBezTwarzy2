...
TAG_MAPPING = {
    ...
    "[POGLĄDY_POLITYCZNE]": "political-view",
    "[ORIENTACJA]": "sexual-orientation",
    "[ZDROWIE]": "health",
    "[KREWNY]": "relative",
    # Tagi proceduralne (generowane, nie z pliku)
    "[WIEK]": "_age",
    "[DATA]": "_date",
    "[DATA_URODZENIA]": "_date_of_birth",
    "[PESEL]": "_pesel",
    "[TELEFON]": "_phone",
    "[EMAIL]": "_email",
    "[KONTO_BANKOWE]": "_bank_account",
    "[KARTA_KREDYTOWA]": "_credit_card",
    "[NR_DOKUMENTU]": "_document",
