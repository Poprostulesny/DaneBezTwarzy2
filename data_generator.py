...
def generate_corpus(n_per_template: int = 300, corrupt_prob: float = 0.25, seed: int = 42, data_dir: str = "data") -> Corpus:
    """
    ...
    Args:
        n_per_template: ile zdań wygenerować dla każdego szablonu
